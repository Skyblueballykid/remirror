...
export interface LinkOptions {
   ...
   *
   * Remirror uses https://www.npmjs.com/package/tlds to provide aa list of all valid TLDs.
   *
   ...
   * const extensions = () => [
   *   new LinkExtension({ autoLinkAllowedTLDs: autoLinkAllowedTLDs: [...TOP_50_TLDS, 'london', 'tech'] })
   * ];
   * ```
   *
